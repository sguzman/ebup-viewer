...
pub(crate) use reader_commands::{
    ...
    reader_load_pdf_render_precomputed, reader_load_pdf_sync_map, reader_next_page,
...
mod tests {
    ...
    fn bridge_command_surface_remains_stable() {
        ...
        assert!(BRIDGE_COMMAND_NAMES.contains(&"reader_load_pdf_render_precomputed"));
    ...
    fn event_contracts_include_request_ids() {
        ...
        let reader_event = ReaderStateEvent {
            ...
            reader: session::ReaderSnapshot {
                ...
                canonical_sentences: vec!["hello".to_string()],
