...
impl<E: Engine> Pipeline<E> {
    ...
    pub fn run_job(&self, input: &Path, job_dir: &Path) -> Result<JobOutput> {
        ...
        info!(
            "probe page_count={} file_bytes={} avg_chars={} garbage_ratio={} whitespace_ratio={} text_page_ratio={} sparse_text_page_ratio={} repeated_header_ratio={} repeated_footer_ratio={} image_page_ratio={} mixed_text_image_page_ratio={} full_page_raster_page_ratio={} hidden_text_layer_page_ratio={} invisible_text_layer_page_ratio={} duplicate_text_page_ratio={} stacked_duplicate_text_page_ratio={}",
            ...
            probe_res.sample.invisible_text_layer_page_ratio,
            probe_res.sample.duplicate_text_page_ratio,
            probe_res.sample.stacked_duplicate_text_page_ratio
        );
        info!(
