...
mod wasm_stub {
    ...
    impl TtsEngine {
        pub fn new(_model_path: PathBuf, _espeak_path: PathBuf) -> Result<Self> {
            Ok(Self)
        }
        ...
        pub fn prepare_batch(
            ...
            _start_idx: usize,
            _threads: usize,
            _progress_log_interval: Duration,
    ...
    impl TtsPlayback {
        ...
        pub fn sentence_durations(&self) -> &[Duration] { &[] }
        pub fn queued_sources(&self) -> usize { 0 }
    }
}
